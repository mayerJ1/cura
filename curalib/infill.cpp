...
void Infill::generate(Polygons& result_polygons, Polygons& result_lines, const sliceData* mesh)
{
...

    {
        ...
        _generate(generated_result_polygons, generated_result_lines, mesh);
...
void Infill::_generate(Polygons& result_polygons, Polygons& result_lines,  const sliceData* mesh)
{
