...
public:
     ...
     */
    void generate(Polygons& result_polygons, Polygons& result_lines, const sliceData* mesh = nullptr);

private:
    /*!
     * Generate the infill pattern without the infill_multiplier functionality
     */
    void _generate(Polygons& result_polygons, Polygons& result_lines,  const sliceData* mesh = nullptr);
